...
function updateSensorReadings(jsonResponse) {
  ...
  let deger1 = Number(jsonResponse.deger1).toFixed(2);
  let deger2 = Number(jsonResponse.deger2).toFixed(2);
  let deger3 = Number(jsonResponse.deger3).toFixed(2);
  let deger4 = Number(jsonResponse.deger4).toFixed(2);

  updateBoxes(temperature, humidity, pressure, altitude, deger1,deger2,deger3,deger4);

  updateGauge(temperature, humidity, pressure, altitude, deger1);
...
function updateBoxes(temperature, humidity, pressure, altitude,deger1,deger2,deger3,deger4) {
  let temperatureDiv = document.getElementById("temperature");
  let humidityDiv = document.getElementById("humidity");
  let pressureDiv = document.getElementById("pressure");
  let altitudeDiv = document.getElementById("altitude");
  let deger1Div = document.getElementById("deger1");
  let deger2Div = document.getElementById("deger2");
  let deger3Div = document.getElementById("deger3");
  let deger4Div = document.getElementById("deger4");

  temperatureDiv.innerHTML = temperature + " C";
  humidityDiv.innerHTML = humidity + " %";
  pressureDiv.innerHTML = pressure + " hPa";
  altitudeDiv.innerHTML = altitude + " m";
  deger1Div.innerHTML = deger1 + " fs";
  deger2Div.innerHTML = deger2 + " fs";
  deger3Div.innerHTML = deger3 + " fs";
  deger4Div.innerHTML = deger4 + " fs";
}
...
function onConnect(message) {
  mqttStatus.textContent = "Bağlandı";
}
